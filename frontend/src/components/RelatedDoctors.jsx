...
const RelatedDoctors = ({ speciality, docId }) => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10' >
      ...
      <p className='sm:w-1/3 tezt-center text-sm' >Simple browse through our extensive list of trusted doctors</p>
        ...
        {relDoc.slice(0, 5).map((item, index) => (
          <div onClick={() => { navigate(`/appointment/${item._id}`); scrollTo(0, 0) }} className='border border-blue-200 rounded-xl overflow-hidden cursor-pointer hover:translate-y-[-10px] transition-all duration-500' >
            ...
            <div className='p-4' >
              ...
              <p className='text-gray-900 taxt-lg font-medium' >{item.name}</p>
